...
def list_duplicates_window(duplicate_files):
    ...
    select_every_other_button = tk.Button(list_window, text="Select Every Other", command=select_every_other)
    select_every_other_button.pack(pady=5)

    select_every_third_button = tk.Button(list_window, text="Select Every Third", command=select_every_third)
    select_every_third_button.pack(pady=5)

    select_all_button = tk.Button(list_window, text="Select All", command=select_all)
